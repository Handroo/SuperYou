...
#import "Missions.h"
@interface ViewMissionViewController : UIViewController<UIScrollViewDelegate,UITextFieldDelegate,UIGestureRecognizerDelegate>
...
@property(nonatomic)BOOL commentPress;
